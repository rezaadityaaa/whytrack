<x-layouts.app>
    <div class="p-6 max-w-lg mx-auto">
        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-8">
            <h2 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-200 text-center">Input Penggunaan Bahan Baku</h2>
            <form action="{{ route('penggunaan-bahan-baku.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required class="w-full border border-blue-200 dark:border-zinc-700 rounded-lg px-3 py-2 bg-blue-50 dark:bg-zinc-900 text-blue-900 dark:text-blue-100">
                ...
                <div class="mb-4">
                    <label for="digunakan_untuk" class="block text-sm font-semibold mb-1 text-blue-900 dark:text-blue-100">Digunakan Untuk</label>
                    <input type="text" name="digunakan_untuk" id="digunakan_untuk" required class="w-full border border-blue-200 dark:border-zinc-700 rounded-lg px-3 py-2 bg-blue-50 dark:bg-zinc-900 text-blue-900 dark:text-blue-100">
                    @error('digunakan_untuk') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div class="mb-4">
                ...
                <div class="flex justify-between items-center pt-2">
                    ...
                    <a href="{{ route('penggunaan-bahan-baku.index') }}" class="text-gray-600 dark:text-gray-300 hover:underline transition">Batal</a>
                </div>
            </form>
        </div>
    </div>
